...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\api\public\storage' => 'string',
...
'cors.supports_credentials','cors.enabled','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\api\\public\\storage','logging.default',
...
'sanctum.csrf-cookie',
'raw_request_commissions.index','raw_request_commissions.store','raw_request_commissions.show','raw_request_commissions.update','raw_request_commissions.destroy','login','storage.local',);
...
'APP_NAME','APP_ENV','APP_KEY','SANCTUM_STATEFUL_DOMAINS','APP_DEBUG',
...
'SESSION_PATH','SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_COOKIE','SESSION_SAMESITE',
